...
def test_return_type():
    user1_id = auth_register(name1@email.com, password, firstname, lastname)
    user2_id = auth_register(name2@email.com, password, firstname, lastname)

    channel_id = channels_create_v1(user1_id, True)
...
def test_invalid_channel_id():
    ...
    user2_id = auth_register(name2@email.com, password, firstname, lastname)
    channels_create_v1(user1_id, True)
...
def test_already_private_channel_member():
    user1_id = auth_register(name1@email.com, password, firstname, lastname)
    channel1_id = channels_create_v1(user1_id, False)
    ...
    user2_id = auth_register(name2@email.com, password, firstname, lastname)
    channel2_id = channels_create_v1(user2_id, False)
...
def test_non_global_owner_joins_private_channel():
    user1_id = auth_register(name1@email.com, password, firstname, lastname)
    channel_id = channels_create_v1(user1_id, False)
