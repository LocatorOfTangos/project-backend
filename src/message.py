...
def message_send_v1(token, channel_id, message, ignore_len=False, message_id=None):
	'''
...
def message_senddm_v1(token, dm_id, message, ignore_len=False, message_id=None):
	'''
